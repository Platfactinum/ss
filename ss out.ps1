...
Write-Host "";
Write-Host "";
Write-Host -ForegroundColor Red "   |  \/  |     /\     |  __ \  |_   _|  / __ \   / ____|   |  _ \      /\     |  \/  |   |__   __|  / __ \   / __ \  | |";
Write-Host -ForegroundColor Red "   | \  / |    /  \    | |__) |   | |   | |  | | | (___     | |_) |    /  \    | \  / |      | |    | |  | | | |  | | | |";
Write-Host -ForegroundColor Red "   | |\/| |   / /\ \   |  _  /    | |   | |  | |  \___ \    |  _ <    / /\ \   | |\/| |      | |    | |  | | | |  | | | |";
Write-Host -ForegroundColor Red "   | |  | |  / ____ \  | | \ \   _| |_  | |__| |  ____) |   | |_) |  / ____ \  | |  | |      | |    | |__| | | |__| | | |";
Write-Host -ForegroundColor Red "   |_|  |_| /_/    \_\ |_|  \_\ |_____|  \____/  |_____/    |____/  /_/    \_\ |_|  |_|      |_|     \____/   \____/  |______|";
Write-Host "";
Write-Host -ForegroundColor Blue "   Made By 5mMario (Shitty ScreenSharer) For Red Lotus ScreenSharing and DFIR - " -NoNewLine
